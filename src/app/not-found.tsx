                ...
                <div className="z-10 flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="mb-20 md:mb-0">
                            <Link href="/">
                                <Button variant={'link'} className="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-yellow-500 hover:text-yellow-600"><i className="mdi mdi-arrow-left mr-2"></i>
                                    Back Home</Button>
                            </Link>
                        </div>
                    </div>
