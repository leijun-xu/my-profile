...
技术栈: 框架react、tailwindcss、js/ts、less/sass、状态库（react-redux/recoil/jotai）、工程化（webpack4/vite）、小程序taro；
2. 自研webpack插件，项目中的性能优化；
3.使用qiankun微前端对多个toB项目的整合；
4.使用react SSR进行网站SEO优化；
5.处理复杂表单，数据结构。
    `
  },
  experiences: [
    {
      ...
      achievements: [
        "负责核心产品的前后端开发",
        "使用React、Node.js、Nextjs、Shadcn/ui、tailwindcss、Next-auth、sso登录等技术栈",
      ]
    }
    ,
    {
