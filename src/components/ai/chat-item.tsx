...
export default function Item({ id, role, parts }: ItemProps) {
    return (
        <div className="flex gap-3 my-4 text-gray-600 text-sm flex-1">
            {
                role === 'user' ?
                    <>
                        ...
                        <div className="leading-relaxed"><span className="block font-bold text-gray-700">You </span>
                            {parts.map((part, index) => (<div key={id + index} className="wrap-break-word">
                        ...
                        <div className="leading-relaxed"><span className="block font-bold text-gray-700">AI </span>
                            {parts.map((part, index) => (<div className="wrap-break-word" key={id + index}>
                                {part.type === 'text' ? part.text : ''
                                }
                            </div>))}
                        </div>
